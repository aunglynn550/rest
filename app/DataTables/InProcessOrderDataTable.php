...
class InProcessOrderDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $view = "<a href='".route('admin.orders.show',$query->id)."' class='btn btn-primary'><i class='fa fa-eye'></i></a>";
            $status = "<a href='javascript:;' class='btn btn-primary ml-2 order_status_btn' data-toggle='modal' data-id='".$query->id."' data-target='#order_modal'>
                        <i class='fa fa-truck-loading'></i></a>";
            $delete = "<a href='".route('admin.orders.destroy',$query->id)."' class='delete-item btn btn-danger ml-2'><i class='fa fa-trash'></i></a></a>";
