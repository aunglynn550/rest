                                    ...
                                    @if($product->productSizes()->exists())
                                        <div class="details_size">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="size-{{ $product->id }}">
                                    ...
                                    <div class="details_quentity">
                                        ...
                                        <div class="quentity_btn_area d-flex flex-wrapa align-items-center">
                                            <div class="quentity_btn">
                                                <button class="btn btn-danger decrement"><i class="fa fa-minus"></i></button>
                                                <input type="text" id="quantity" name="quantity" placeholder="1" value="1" readonly>
                                                <button class="btn btn-success increment"><i class="fa fa-plus"></i></button>
                                            </div>
                                            @if($product->offer_price > 0)
    ...
    <script>
        $(document).ready(function(){
            ...
            function updateTotalPrice(){
                ...
                // Selectd size Price
                let selectSize = $('input[name="product_size"]:checked');
            ...
            $("#modal_add_to_cart_form").on('submit',function(e){
                ...
                $.ajax({
                    ...
                    beforeSend:function(){
                        ...
                        $('.modal_cart_button').html('<span class="spinner-border spinner-border-sm" role="status text-light" aria-hidden="true"></span>Loading') 
