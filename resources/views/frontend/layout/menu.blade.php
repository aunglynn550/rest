    ...
    <div class="fp__menu_cart_area">
        <div class="fp__menu_cart_boody">
            <div class="fp__menu_cart_header">
                <h5>total item (<span class="cart_count" style="font-size: 18px;">{{ count(Cart::content()) }}</span>)</h5>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="fp__reservation_form" action="{{ route('reservation.store') }}" method="POST">
                            ...
                            <input class="reservation_input" type="text" placeholder="Person" name="person">
