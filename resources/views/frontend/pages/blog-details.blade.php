...
@section('content')
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        <a href="{{ route('blog.details',$latestBlog->slug) }}">
                                            {{ truncate($latestBlog->title,30) }}
                                        </a>
                                        <p><i class="far fa-calendar-alt"></i> 
                                        {{ date("F j, Y, g:i a", strtotime($latestBlog->created_at))}}
                                        </p>
                                    </div>
                                </li>
                                @endforeach                                                         
    ...
    <!--=========================
        BLOG DETAILS END https://www.facebook.com/sharer/sharer.php?u=YOUR_URL
    ==========================-->
