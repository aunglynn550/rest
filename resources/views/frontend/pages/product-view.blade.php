                    ...
                    <div class="fp__menu_details_text">
                        ...
                        <form action="" id="v_add_to_cart_form">
                            ...
                            <input type="hidden" name="base_price" class="v_base_price" 
                                value="{{ $product->offer_price > 0 ? $product->offer_price : $product->product_price }}">
                                ...
                                <div class="details_quentity">
                                    ...
                                    <div class="quentity_btn_area d-flex flex-wrapa align-items-center">
                                        <div class="quentity_btn">
                                            ...
                                            <input name="quantity" type="text" placeholder="1" value="1" readonly id="v_quantity">
                        ...
                        <div class="fp__menu_item">
                            ...
                            <div class="fp__menu_item_text">
                                ...
                                <ul class="d-flex flex-wrap justify-content-center">
                                    <li><a href="javascript:;" onclick="loadProductModel('{{ $relatedProduct->id }}')"><i
...
<script>
    ...
    function v_updateTotalPrice(){
                ...
                // Selectd size Price
                let selectSize = $('.v_product_size:checked');
                if(selectSize.length > 0){
                    selectedSizePrice = parseFloat(selectSize.data("price"));                    
                }   
              ...
              $("#v_add_to_cart_form").on('submit',function(e){
                ...
                $.ajax({
                    ...
                    beforeSend:function(){
                        ...
                        $('.v_submit_button').html('<span class="spinner-border spinner-border-sm" role="status text-light" aria-hidden="true"></span>Loading') 
